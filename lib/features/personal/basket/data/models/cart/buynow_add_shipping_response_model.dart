...
import '../../../domain/entities/cart/buynow_add_shipping_response_entity.dart';

class BuyNowAddShippingResponseModel extends BuyNowAddShippingResponseEntity {
  BuyNowAddShippingResponseModel({
    required super.message,
    required super.selectedShipping,
    required super.ratesKey,
  });

  factory BuyNowAddShippingResponseModel.fromJson(Map<String, dynamic> json) {
    final List<dynamic> list =
        json['selected_shipping'] as List<dynamic>? ?? <dynamic>[];
    return BuyNowAddShippingResponseModel(
      message: json['message'] ?? '',
      selectedShipping: list
          .map(
            (dynamic e) =>
                SelectedShippingModel.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      ratesKey: json['rates_key'] ?? '',
    );
  }
...
class ParcelModel extends ParcelEntity {
  ...
  factory ParcelModel.fromJson(Map<String, dynamic> json) {
    return ParcelModel(
      length: json['length'] ?? '',
      width: json['width'] ?? '',
      distanceUnit: json['distanceUnit'] ?? json['distance_unit'] ?? '',
      weight: json['weight'] ?? '',
      massUnit: json['massUnit'] ?? json['mass_unit'] ?? '',
      height: json['height'] ?? '',
    );
  }
