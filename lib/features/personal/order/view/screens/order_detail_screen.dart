  ...
  Widget build(BuildContext context) {
    ...
    if (order == null) {
      return Scaffold(
        ...
        body: Center(child: Text('something_wrong'.tr())),
      );
    }
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          style: IconButton.styleFrom(
            backgroundColor:
                Theme.of(context).colorScheme.outline.withAlpha(25), // fixed
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      OrderActionButtonsList(order: order),
                    ],
                  ),
                ),
              );
          ...
          children: <Widget>[
            ...
            if (order.orderStatus == StatusType.pending.json)
              OrderActionButton(
                ...
                color: Theme.of(context).colorScheme.outline,
                onTap: () => orderPro.updateOrder(order.orderId, 'canceled'),
              ),
            OrderActionButton(
              isLoading: orderPro.isLoading,
