...
class PersonalSettingEmailNotificationScreen extends StatelessWidget {
  ...
  static const String routeName = '/email_notification';
      ...
      body: ListView(
        ...
        children: <Widget>[
          CustomSwitchListTile(
            title: 'enable_email_notification'.tr(),
            value: provider.enableEmailNotification,
            onChanged: (bool value) {
              provider.toggleEmailNotification(value);
            },
          ),
          const Divider(),
          InDevMode(
