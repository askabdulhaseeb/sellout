          ...
          children: <Widget>[
            ...
            Expanded(
              child: DropdownButtonFormField<String>(
                ...
                value: pro.selectedclothBrand,
                isExpanded: true,
                onChanged: (String? newValue) {
                  pro.setclothBrand(newValue);
                },
                items: pro.getclothBrands().map((String brand) {
          ...
          children: <Widget>[
            Expanded(
              child: DropdownButtonFormField<String>(
                ...
                value: pro.selectedclothSize, // Selected size
                isExpanded: true,
                onChanged: (String? newValue) {
                  pro.setclothsize(newValue); // Update selected size
                  pro.setAvailableclothColors(newValue);
                },
                items: pro.getclothSize().map((SizeColorEntity size) {
                  return DropdownMenuItem<String>(
                    value: size.value,
            ...
            Expanded(
              child: DropdownButtonFormField<String>(
                ...
                value: pro.selectedclothColor,
                isExpanded: true,
                onChanged: (String? newValue) {
                  pro.setclothColor(newValue);
                },
                items: pro.availableclothColors.map((ColorEntity colorEntity) {
                  return DropdownMenuItem<String>(
