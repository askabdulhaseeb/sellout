...
class MarketFilterpropertyCategoryAndLocationWIdget extends StatelessWidget {
  const MarketFilterpropertyCategoryAndLocationWIdget({super.key});

  @override
  Widget build(BuildContext context) {
    /// 🟩 get energy rating options from local Hive source
    final List<DropdownOptionEntity> energyRatingOptions =
        LocalCategoriesSource.energyRating ?? <DropdownOptionEntity>[];
          ...
          children: <Widget>[
            Expanded(
              child: CustomListingDropDown<MarketPlaceProvider,
                ...
                onChanged: (String? p0) => marketPro.setEnergyRating(p0),
              ),
            ),
            ...
            Expanded(
              child: NominationLocationField(
                ...
                selectedLocation: marketPro.selectedLocation,
