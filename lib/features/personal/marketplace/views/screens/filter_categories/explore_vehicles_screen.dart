...
//                         //   hint: 'postcode'.tr(),
//                         //   controller: MarketPlaceProvider.postodeController,
//                         // )),
//                         Expanded(
...
//                             ),
//                             value: pro.selectedmodelvehicle,
//                             isExpanded: true,
//                             onChanged: (String? newValue) =>
//                                 pro.setvehiclemodel(newValue),
//                             items: pro
//                                 .getVehiclemodel()
...
//                               overflow: TextOverflow.ellipsis,
//                             ),
//                             value: pro.selectedVehicleCategory,
//                             isExpanded: true,
//                             onChanged: (String? newValue) =>
//                                 pro.setvehiclecategory(newValue),
//                             items: pro
//                                 .getVehicleCategory()
//                                 .map<DropdownMenuItem<String>>(
//                                     (String delivery) => DropdownMenuItem(
...
//                               overflow: TextOverflow.ellipsis,
//                             ),
//                             value: pro.selectedyearvehicle,
//                             isExpanded: true,
//                             onChanged: (int? newValue) =>
//                                 pro.setvehicleyear(newValue),
//                             items: pro.getVehicleyear().map((int? delivery) {
...
//                               overflow: TextOverflow.ellipsis,
//                             ),
//                             value: pro.selectedmakevehcle,
//                             isExpanded: true,
//                             onChanged: (String? newValue) =>
//                                 pro.setvehiclemake(newValue),
//                             items: pro
//                                 .getVehiclemake()
//                                 .map<DropdownMenuItem<String>>(
//                                     (String? delivery) => DropdownMenuItem(
...
//                         isLoading: false,
//                         onTap: () {
//                           pro.applyvehicleFIlter();
//                           debugPrint(
//                               'filtered list:${pro.vehicleCategoryFilteredList}');
//                         },
//                         title: 'search'.tr()),
//                     const SizedBox(width: 10),
//                     Row(
